...
function find_first_empty_cell(column: number) {
...
function check_direction(row: number, column: number, row_dir: number, col_dir: number) {
...
function highlight_winning_tokens(winning_positions: Array<{ row: number, column: number }>) {
...
function handle_mouse_out(column: number) {
